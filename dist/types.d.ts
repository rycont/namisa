...
export declare type DirectoryTree = Tree<{
    isDirectory?: boolean;
    rawPath: string;
}>;
export declare type ComponentMap = Record<string, () => Promise<unknown>>;
...
export declare type Control = TypedControl | OptionControl | NumberSliderControl | NumberControl;
